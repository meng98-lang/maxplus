  ...
  return (
    <>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#packages" className="px-8 py-3 bg-amber-600 hover:bg-amber-700 text-white font-medium rounded-lg transition-colors text-center">
                  View Packages
                </a>
                <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="px-8 py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
                  <MessageCircle className="w-5 h-5" />
                  WhatsApp
                </a>
              </div>
            </div>
            <div className="aspect-square bg-gray-100 rounded-2xl p-12">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            {[
              ...
              { icon: <Zap className="w-6 h-6" />, title: 'Fast Acting', desc: '60 sec absorption' },
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className={`bg-white rounded-xl border-2 ${pkg.badge ? 'border-amber-500 shadow-lg' : 'border-gray-200'} p-8 flex flex-col`}>
                {pkg.badge && <div className="bg-amber-500 text-white text-xs font-bold px-3 py-1 rounded-full mb-4 self-start">{pkg.badge}</div>}
                ...
                <a href={`https://wa.me/${whatsappNumber}?text=${encodeURIComponent(`Order: MaxPlus+ ${pkg.name} - $${pkg.price}`)}`} target="_blank" rel="noopener noreferrer" className="w-full py-3 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg transition-colors flex items-center justify-center gap-2">
      ...
      <section className="bg-gray-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-3">Natural Ingredients</h2>
            <p className="text-gray-600">Premium herbal extracts</p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            {[
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="text-center">
                <div className="w-12 h-12 bg-amber-600 rounded-full flex items-center justify-center text-xl font-bold text-white mx-auto mb-4">{s.step}</div>
      ...
      <section className="bg-amber-600 py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-amber-100 mb-8">Order now via WhatsApp</p>
          <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 px-8 py-4 bg-white text-amber-600 font-bold rounded-lg transition-colors">
            <MessageCircle className="w-5 h-5" />
            Order via WhatsApp
          </a>
        </div>
      ...
      <footer className="bg-gray-900 text-gray-400 py-8">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xs text-gray-500 mt-2">These statements have not been evaluated by the FDA.</p>
        </div>
      </footer>
